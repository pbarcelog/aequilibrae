# centroid-connector-inference Specification

## Purpose

Spread-based centroid connector placement when a project has zones and network nodes but no centroid connectors,
for federated network-and-demand workflows.
